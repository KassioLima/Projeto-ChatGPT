...
application.add_handler(CommandHandler("listarconversas", telegramService.listarConversas))
application.add_handler(CommandHandler("apagarconversa", telegramService.apagarConversa))
application.add_handler(CommandHandler("continuarconversa", telegramService.continuarConversa))
